...
from ui.settings_tabs.software_components.remote_explorer import RemoteExplorerWidget
from ui.settings_tabs.software_components.manifest_editor import ManifestEditorWidget
